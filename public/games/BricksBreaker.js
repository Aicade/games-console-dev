...
function gameSceneCreate(game) {
  ...
  paddle = game.physics.add
    .sprite(game.width * 0.5, paddleY, "platform")
    .setDisplaySize(200, 35)
    .setImmovable();
  paddle.refreshBody();

  ball = game.physics.add
    .sprite(game.width * 0.5, paddle.y - 16, "projectile")
  ...
  game.gameOverText = game.add
    .bitmapText(game.width / 2, 40, "pixelfont", "GAME OVER !", 40)
    .setDepth(11)
    .setOrigin(0.5)
    .setTint(0xff0000)
    .setAlpha(0);
